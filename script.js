document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (type === 'url') {
        try {
          ...
          showFieldError(field, getErrorMessage('url', name));
          isValid = false;
          return;
        }
      }
      ...
      if (field.hasAttribute('pattern')) {
        ...
        if (!pattern.test(value)) {
          showFieldError(field, getErrorMessage('pattern', name));
          isValid = false;
          return;
        }
      }
  ...
  function getErrorMessage(type, fieldName, param) {
    ...
    return labels[type] || 'Invalid value.';
  }
  ...
  document.body.addEventListener('input', function (e) {
    ...
    if (field.classList.contains('field-error')) {
      ...
      if (errorMsg && errorMsg.classList && errorMsg.classList.contains('field-error-msg')) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'a066fb32-6765-47ef-832a-bd4fb6bcc991',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'a066fb32-6765-47ef-832a-bd4fb6bcc991';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a066fb32-6765-47ef-832a-bd4fb6bcc991';
